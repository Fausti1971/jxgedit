...
/***************************************************************************************************************************/
	...
	private final XGAddressableSet<XGModule> structure;
	...
	private XGDevice()
	{	this.defaultFileName = new StringBuffer("default.syx");
		...
		XGTable.init(this);
//		XGModule.init(this);
//		XGBulkDump.init(this);
//		XGOpcode.init(this);
		this.structure = XGModule.init(this);
...
//		XGOpcode.init(this);
	...
	public XGAddressableSet<XGModule> getStructure()
